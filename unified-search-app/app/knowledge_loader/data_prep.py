...
def get_entity_data(dataset: str, _datasource: Datasource) -> pd.DataFrame:
    """
    Returns a dataframe with entity data from the indexed-data.
    """
...
def get_communities_data(
    ...
    """
    Returns a dataframe with communities data from the indexed-data.
    """
    communities_df = _datasource.read(config.communities_table)
