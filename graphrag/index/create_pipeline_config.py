        ...
        PipelineWorkflowReference(
            ...
            config={
                "document_raw_content_embed": _get_embedding_settings(
                    ...
                    {"title_column": "raw_content", "collection_name": "final_documents_raw_content_embedding"}
                ),
        ...
        PipelineWorkflowReference(
            ...
            config={
                "entity_name_embed": _get_embedding_settings(
                    ...
                    {"title_column": "name", "collection_name": "entity_name_embeddings"}
                ),
                "entity_name_description_embed": _get_embedding_settings(
                    settings.embeddings, "entity_name_description",
                    {"title_column": "description", "collection_name": "entity_description_embeddings"}
                ),
        ...
        PipelineWorkflowReference(
            ...
            config={
                "relationship_description_embed": _get_embedding_settings(
                    ...
                    {"title_column": "description", "collection_name": "relationships_description_embeddings"}
                ),
        ...
        PipelineWorkflowReference(
            ...
            config={
                ...
                "community_report_full_content_embed": _get_embedding_settings(
                    ...
                    {"title_column": "full_content", "collection_name": "final_community_reports_full_content_embedding"}
                ),
                "community_report_summary_embed": _get_embedding_settings(
                    settings.embeddings, "community_report_summary",
                    {"title_column": "summary", "collection_name": "final_community_reports_summary_embedding"}
                ),
                "community_report_title_embed": _get_embedding_settings(
                    settings.embeddings, "community_report_title", {"title_column": "title"}
                ),
            },
        ),
    ]
