...
local_search:
  ...
  # temperature: {defs.LOCAL_SEARCH_LLM_TEMPERATURE} # temperature for sampling
  # top_p: {defs.LOCAL_SEARCH_LLM_TOP_P} # top-p sampling
  # n: {defs.LOCAL_SEARCH_LLM_N} # Number of completions to generate
  # max_tokens: {defs.LOCAL_SEARCH_MAX_TOKENS}

global_search:
  # temperature: {defs.GLOBAL_SEARCH_LLM_TEMPERATURE} # temperature for sampling
  # top_p: {defs.GLOBAL_SEARCH_LLM_TOP_P} # top-p sampling
  # n: {defs.GLOBAL_SEARCH_LLM_N} # Number of completions to generate
