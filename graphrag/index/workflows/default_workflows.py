...
from .v1.create_final_embeddings import (
    build_steps as build_create_final_embeddings_steps,
)

from .v1.create_final_embeddings import (
    workflow_name as create_final_embeddings,
)
...
default_workflows: WorkflowDefinitions = {
    ...
    create_final_embeddings: build_create_final_embeddings_steps,
}
