...
This API provides a set of functions that external applications can leverage to hook into graphrag
and run a variety of queries over a knowledge generated by graphrag.

WARNING: The API is under development and may change between releases. Users should
