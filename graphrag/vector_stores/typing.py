...
from .couchbasedb import CouchbaseVectorStore
...
class VectorStoreFactory:
    ...
    def get_vector_store(
    ...
    ) -> LanceDBVectorStore | AzureAISearch | CouchbaseVectorStore:
        ...
        match vector_store_type:
            ...
            case VectorStoreType.Couchbase:
                return CouchbaseVectorStore(**kwargs)
            case _:
