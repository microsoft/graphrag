...
async def create_final_text_units(
    ...
    async for row in text_units_table:
        fields = {
            ...
            "start_turn_index": row.get("start_turn_index"),
            "end_turn_index": row.get("end_turn_index"),
            "turn_timestamp_start": row.get("turn_timestamp_start"),
            "turn_timestamp_end": row.get("turn_timestamp_end"),
            "included_roles": row.get("included_roles", []),
            "chunk_index_in_document": row.get("chunk_index_in_document"),
            "chunk_index_in_conversation": row.get("chunk_index_in_conversation"),
