...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddGraphRag(this IServiceCollection services)
    {
        ...
        services.AddKeyedSingleton<WorkflowDelegate>(Indexing.Workflows.HeuristicMaintenanceWorkflow.Name, static (_, _) => Indexing.Workflows.HeuristicMaintenanceWorkflow.Create());
